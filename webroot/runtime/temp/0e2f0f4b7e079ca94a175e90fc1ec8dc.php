     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5f3d4bbf6e0b7=explode(',',$maccms['search_hot']); if(is_array($_5f3d4bbf6e0b7) || $_5f3d4bbf6e0b7 instanceof \think\Collection || $_5f3d4bbf6e0b7 instanceof \think\Paginator): if( count($_5f3d4bbf6e0b7)==0 ) : echo "" ;else: foreach($_5f3d4bbf6e0b7 as $key=>$vo): if($key < 5): ?>
