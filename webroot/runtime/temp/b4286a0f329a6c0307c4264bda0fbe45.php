     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5f3d4b8794384=explode(',',$maccms['search_hot']); if(is_array($_5f3d4b8794384) || $_5f3d4b8794384 instanceof \think\Collection || $_5f3d4b8794384 instanceof \think\Paginator): if( count($_5f3d4b8794384)==0 ) : echo "" ;else: foreach($_5f3d4b8794384 as $key=>$vo): if($key < 5): ?>
